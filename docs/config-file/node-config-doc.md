...
### <a name="Sequencer_L2Coinbase"></a>10.16. `Sequencer.L2Coinbase`
...
### <a name="Sequencer_Finalizer"></a>10.17. `[Sequencer.Finalizer]`
...
#### <a name="Sequencer_Finalizer_GERDeadlineTimeout"></a>10.17.1. `Sequencer.Finalizer.GERDeadlineTimeout`
...
#### <a name="Sequencer_Finalizer_ForcedBatchDeadlineTimeout"></a>10.17.2. `Sequencer.Finalizer.ForcedBatchDeadlineTimeout`
...
#### <a name="Sequencer_Finalizer_SleepDuration"></a>10.17.3. `Sequencer.Finalizer.SleepDuration`
...
#### <a name="Sequencer_Finalizer_ResourcePercentageToCloseBatch"></a>10.17.4. `Sequencer.Finalizer.ResourcePercentageToCloseBatch`
...
#### <a name="Sequencer_Finalizer_GERFinalityNumberOfBlocks"></a>10.17.5. `Sequencer.Finalizer.GERFinalityNumberOfBlocks`
...
#### <a name="Sequencer_Finalizer_ClosingSignalsManagerWaitForCheckingL1Timeout"></a>10.17.6. `Sequencer.Finalizer.ClosingSignalsManagerWaitForCheckingL1Timeout`
...
#### <a name="Sequencer_Finalizer_ClosingSignalsManagerWaitForCheckingGER"></a>10.17.7. `Sequencer.Finalizer.ClosingSignalsManagerWaitForCheckingGER`
...
#### <a name="Sequencer_Finalizer_ClosingSignalsManagerWaitForCheckingForcedBatches"></a>10.17.8. `Sequencer.Finalizer.ClosingSignalsManagerWaitForCheckingForcedBatches`
...
#### <a name="Sequencer_Finalizer_ForcedBatchesFinalityNumberOfBlocks"></a>10.17.9. `Sequencer.Finalizer.ForcedBatchesFinalityNumberOfBlocks`
...
#### <a name="Sequencer_Finalizer_TimestampResolution"></a>10.17.10. `Sequencer.Finalizer.TimestampResolution`
...
#### <a name="Sequencer_Finalizer_StopSequencerOnBatchNum"></a>10.17.11. `Sequencer.Finalizer.StopSequencerOnBatchNum`
...
#### <a name="Sequencer_Finalizer_SequentialReprocessFullBatch"></a>10.17.12. `Sequencer.Finalizer.SequentialReprocessFullBatch`
...
### <a name="Sequencer_DBManager"></a>10.18. `[Sequencer.DBManager]`
...
#### <a name="Sequencer_DBManager_PoolRetrievalInterval"></a>10.18.1. `Sequencer.DBManager.PoolRetrievalInterval`
...
#### <a name="Sequencer_DBManager_L2ReorgRetrievalInterval"></a>10.18.2. `Sequencer.DBManager.L2ReorgRetrievalInterval`
...
### <a name="Sequencer_EffectiveGasPrice"></a>10.19. `[Sequencer.EffectiveGasPrice]`
...
#### <a name="Sequencer_EffectiveGasPrice_MaxBreakEvenGasPriceDeviationPercentage"></a>10.19.1. `Sequencer.EffectiveGasPrice.MaxBreakEvenGasPriceDeviationPercentage`
...
#### <a name="Sequencer_EffectiveGasPrice_L1GasPriceFactor"></a>10.19.2. `Sequencer.EffectiveGasPrice.L1GasPriceFactor`
...
#### <a name="Sequencer_EffectiveGasPrice_ByteGasCost"></a>10.19.3. `Sequencer.EffectiveGasPrice.ByteGasCost`
...
#### <a name="Sequencer_EffectiveGasPrice_MarginFactor"></a>10.19.4. `Sequencer.EffectiveGasPrice.MarginFactor`
...
#### <a name="Sequencer_EffectiveGasPrice_Enabled"></a>10.19.5. `Sequencer.EffectiveGasPrice.Enabled`
...
#### <a name="Sequencer_EffectiveGasPrice_DefaultMinGasPriceAllowed"></a>10.19.6. `Sequencer.EffectiveGasPrice.DefaultMinGasPriceAllowed`
